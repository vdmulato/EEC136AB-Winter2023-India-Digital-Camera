// ======================================================================
// clcd_063proto_210114.v generated from TopDesign.cysch
// 03/09/2023 at 21:04
...
module Scan_ADC_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("0bd414d8-af0b-4e82-8ef0-acba784dd85b/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
	...
	wire [0:0] tmpFB_0__Positive_net;
	wire [0:0] tmpIO_0__Positive_net;
	electrical [0:0] tmpSIOVREF__Positive_net;

	cy_mxs40_gpio_v1_0
		#(.id("66c75f1e-4c1a-4137-bca3-d396f8eab788"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		Positive
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Positive_net[0:0]}),
		  .analog({Net_91}),
		  .io({tmpIO_0__Positive_net[0:0]}),
		  .siovref(tmpSIOVREF__Positive_net));


    Scan_ADC_v3_10_1 ADC_1 (
        .eos(Net_130),
        .sdone(Net_131),
        .t_chid(Net_132[3:0]),
        .t_chidv(Net_133),
	...
	cy_mxs40_gpio_v1_0
		#(.id("3aa8353a-5084-4d41-83cc-6980e5fededc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("24d87577-b156-4b7f-ab2b-4c9cccb2e380"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("e1db5878-12de-4d8e-b7ce-62403242e915"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("95ad4133-02eb-4cb2-8694-767d4498fa19"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a22c167c-1e70-467d-8803-9fb22aec6a07"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("f02ef745-b72e-49c3-8557-ba8237b8fded"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("59521385-fbf8-484b-90da-a11d81323e80"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("fb484d1e-46a7-4281-96f3-923489ddde35"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("e5180d9d-c748-4d30-b01a-b9e5c1bed462"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
